...
ActiveRecord::Schema.define(version: 2020_08_21_104547) do
  ...
  create_table "reviews", force: :cascade do |t|
   ...
   create_table "favorite_equipments", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["equipment_id"], name: "index_favorite_equipments_on_equipment_id"
    t.index ["user_id"], name: "index_favorite_equipments_on_user_id"
  end
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["equipment_id"], name: "index_favorites_on_equipment_id"
